-- Verifies each Phase 3.0.3 table has a primary key.
...
BEGIN
    ...
    IF missing_pk_tables <> '' THEN
        RAISE EXCEPTION 'Missing/invalid PK on Phase 3.0.3 tables: %', missing_pk_tables;
    END IF;

    RAISE NOTICE 'PASS: Phase 3.0.3 primary keys exist.';
END
$$;
