-- Verifies Phase 4 does not create grading runtime tables.
...
BEGIN
    ...
    IF unexpected <> '' THEN
        RAISE EXCEPTION 'Unexpected grading artifacts created in Phase 4: %', unexpected;
    END IF;

    RAISE NOTICE 'PASS: No legacy grading runtime tables were created by Phase 4.';
END
$$;
