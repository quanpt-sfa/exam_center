-- Verifies grading profile insert graph from exam_version/question_template/blueprint_rule/module_version.
...
BEGIN
    ...
    VALUES ('SMOKE_P24_DEPT_' || suffix, 'Smoke P24 Department ' || suffix, 'ACTIVE')
    RETURNING department_id INTO v_department_id;

    INSERT INTO academic.term (term_code, term_name, start_date, end_date, status)
    VALUES ('SMOKE_P24_TERM_' || suffix, 'Smoke P24 Term ' || suffix, CURRENT_DATE, CURRENT_DATE + INTERVAL '90 days', 'ACTIVE')
    ...
    VALUES (v_department_id, 'SMOKE_P24_COURSE_' || suffix, 'Smoke P24 Course ' || suffix, 'SQL_SERVER', 3.0, 'ACTIVE')
    RETURNING course_id INTO v_course_id;

    INSERT INTO academic.course_offering (course_id, term_id, offering_code, coordinator_id, status)
    VALUES (v_course_id, v_term_id, 'SMOKE_P24_OFF_' || suffix, NULL, 'ACTIVE')
    ...
    VALUES (
        ...
        'SMOKE_P24_EXAM_' || suffix,
        'Smoke P24 Exam ' || suffix,
        'Smoke insert-graph exam for Phase 2.4',
        'DRAFT',
        v_user_id
    )
    ...
    VALUES (
        v_course_id,
        'SMOKE_P24_BANK_' || suffix,
        'Smoke P24 Bank ' || suffix,
        'Smoke insert-graph bank for Phase 2.4',
        v_user_id,
        'ACTIVE'
    )
    ...
    VALUES (
        'SMOKE_P24_TEMPLATE_' || suffix,
        'SQL_QUERY',
        'Smoke P24 Template ' || suffix,
    ...
    VALUES (
        v_exam_version_id,
        'SMOKE_P24_BP_' || suffix,
        'Smoke P24 Blueprint ' || suffix,
        1,
        5.00,
        'RANDOM_FROM_BANK',
        'ACTIVE'
    ...
    VALUES (
        ...
        v_blueprint_rule_id,
        v_module_version_id,
        'SMOKE_P24_PROFILE_' || suffix,
        '{"timeout_seconds":5,"allow_ddl":false}'::jsonb,
        'ACTIVE'
    )
    RETURNING grading_profile_id INTO v_grading_profile_id;

    DELETE FROM assessment.grading_profile WHERE grading_profile_id = v_grading_profile_id;
    ...
    RAISE NOTICE 'PASS: Phase 2.4 grading profile insert graph succeeded.';
END
$$;