-- Verifies all Phase 4 submission/capture tables have primary keys.
...
BEGIN
    ...
    IF invalid_tables <> '' THEN
        RAISE EXCEPTION 'Missing/invalid Phase 4 primary keys on: %', invalid_tables;
    END IF;

    RAISE NOTICE 'PASS: All Phase 4 primary keys exist.';
END
$$;
