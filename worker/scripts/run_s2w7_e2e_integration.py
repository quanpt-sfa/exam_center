#!/usr/bin/env python3
"""Run the S2W-7 E2E harness integration and smoke pack."""
...
INTEGRATION_GROUPS: list[tuple[str, list[str]]] = [
    (
        "S2W-7 E2E harness smoke",
        [
            "apps/worker/tests/test_s2w7_e2e_harness_postgres_integration.py",
        ],
    ),
    (
        "S2W-7 direct TEXTBOX_SQL E2E",
        [
            "apps/worker/tests/test_s2w7_textbox_sql_e2e_postgres_integration.py",
        ],
    ),
    (
        "S2W-7 STUDENT_DATABASE_CAPTURE E2E",
        [
            "apps/worker/tests/test_s2w7_capture_e2e_postgres_integration.py",
        ],
    ),
    (
        "S2W-7 negative/security E2E",
        [
            "apps/worker/tests/test_s2w7_security_failure_e2e_postgres_integration.py",
        ],
    ),
]
...
SMOKE_FILES: list[str] = [
    "db/postgres/05_tests/278_assert_s2w7_e2e_prerequisites_ready.sql",
]
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run S2W-7 E2E harness integration pack")
    parser.add_argument(
        "--group",
        action="append",
        default=[],
    ...
    parser.add_argument("--skip-smoke", action="store_true", help="Skip DB smoke SQL 278")
    parser.add_argument(
        "--db-name",
        default=None,
    ...
    print("S2W-7 E2E harness integration pack")
    ...
    print("\n[OK] S2W-7 E2E harness integration pack passed.")
    return 0
